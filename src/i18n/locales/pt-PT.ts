export default {
  translation: {
    ...
    'Follow privately by default': 'Seguir em privado por predefinição',
    'New follows will not appear on your public follow list': 'Os novos follows não aparecerão na sua lista pública',
    'Convert public follows to private': 'Converter follows públicos em privados',
    'Move everyone you follow publicly onto your encrypted private follow list': 'Mover todas as pessoas que segue em público para a lista privada encriptada',
    'Convert public follows to private?': 'Converter follows públicos em privados?',
    'This will hide your current public follow list from other people. You can switch individual follows back to public later.': 'Isto irá ocultar a sua lista pública atual. Mais tarde pode voltar a tornar follows individuais públicos.',
